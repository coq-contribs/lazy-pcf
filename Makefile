...
.PHONY: all opt byte archclean clean install depend xml OpSem SubjRed
...
depend:
	(cd OpSem ; $(MAKE) depend)
	(cd SubjRed ; $(MAKE) depend)
...
install:
	...
	(cd OpSem ; $(MAKE) install)
	(cd SubjRed ; $(MAKE) install)
...
clean:
	...
	(cd OpSem ; $(MAKE) clean)
	(cd SubjRed ; $(MAKE) clean)

archclean:
	rm -f *.cmx *.o
	(cd OpSem ; $(MAKE) archclean)
	(cd SubjRed ; $(MAKE) archclean)
